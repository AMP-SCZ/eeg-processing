...
% 	sessions = {    'PrescientAD', 'AD00051', '20220429' };
...
% 			sessions = {    'PronetNC', 'NC00002', '20220408' }; VODMMNruns = [1:6]; AODruns = [1:3]; ASSRruns = [0]; RestEOruns = [0]; RestECruns = [0];			%incomplete [6VODMMN,3AOD], don't bother
