...
% DatetimeType option to readtable added by SCN 9/8/2021 to deal with ft_write_tsv.m crash
% due to output_compatible subfunction not handling 'datetime' class.
% datetime introduced in R2014b
% I also modified ft_write_tsv.m adding datetime class support
